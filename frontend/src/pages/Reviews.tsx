...
import { Star, ThumbsUp, CheckCircle2, Lock, Loader2, Send, BookOpen, Flag, X } from "lucide-react";
            ...
            <CardContent className="p-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={selectedCourse === "All Courses" ? "" : selectedCourse}
                  onChange={(e) => setSelectedCourse(e.target.value || "All Courses")}
                />
              </div>
            </CardContent>
          </Card>
